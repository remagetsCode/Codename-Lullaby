...
function onDiscordPresenceUpdate(e) {
	...
	if(data.button1Label == null)
		data.button1Label = "Go play it?"; // "Codename Engine Discord"
	if(data.button1Url == null)
		data.button1Url = "https://gamebanana.com/mods/614853";
}

function onPlayStateUpdate() {
	DiscordUtil.config.logoKey = PlayState.instance.curSong != "shinte" ? PlayState.instance.curSong : "unknown";
