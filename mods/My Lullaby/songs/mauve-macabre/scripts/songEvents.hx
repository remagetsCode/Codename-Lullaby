...
function stepHit(stepHit) {
	switch (curStep) {
		case 1036 | 1296 | 2068 | 2320 | 2756:
			FlxTween.num(0.0010, 0.10, 1, {onUpdate: (v) -> missingno.GLITCH_THR = v.value});
		case 1056 | 1314 | 2080 | 2336:
			FlxTween.num(0, 0, 1, {onUpdate: (v) -> missingno.GLITCH_THR = v.value});
	}
}
